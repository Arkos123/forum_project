...
public final class Const {
    //JWT令牌
    public final static String JWT_BLACK_LIST = RedisKeys.JWT_BLACK_LIST;
    public final static String JWT_FREQUENCY = "jwt:frequency:";
    //请求频率限制
    public final static String FLOW_LIMIT_COUNTER = "flow:counter:";
    public final static String FLOW_LIMIT_BLOCK = "flow:block:";
    public final static String BANNED_BLOCK = RedisKeys.BANNED_BLOCK;
    //邮件验证码
    ...
    //请求自定义属性
    public final static String ATTR_USER_ID = RequestAttributes.USER_ID;
    //消息队列
